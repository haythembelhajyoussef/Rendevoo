                        ...
                        <div class="wizard show-submit">                                
                            ...
                            <div id="step-1">   
                                ...
                                <div style="width: 700px; margin: auto;padding-top: 30px;">
                                    <calendrier action="controlleur/ajouteRdvControl.php?" dataid="<?php echo $professionnel->getId() ?>" datas="0" dataduree="<?php echo $professionnel->getCalendrier()->getDuree() ?>"></calendrier>
                                </div>
                            </div>
